...
Для роботи коду вам потрібно завантажити важливі компоненти программи, а саме:

	1.python 3.11 чи вище. Можна завантажити з офіційного сайту python.
...
Для запуску программи треба ввійти в команднний рядок, і командою "cd (директорія)" указатишлях до тієї папки, де ви встановили цей проект. Після чого написати ще одну команду "python main.py".
